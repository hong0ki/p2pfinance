					...
					<ul class="header_contact">
						<li class="c_1">
							...
							<div class="ceng" id="weixin_xlgz" style="display: none;">
								...
								<b class="ar_up ar_top"></b>
								<b class="ar_up_in ar_top_in"></b> </div>
						</li>
						<li class="c_2">
							<a href="#" target="_blank" title="官方QQ" alt="官方QQ">
								<b class="ico_head_QQ"></b></a>
						</li>
						<li class="c_4">
			...
			<div class="header min-width">
				<div class="container">
					...
					<ul class="top-nav fn-clear">
						...
						<li>
							<a href="apply.html" class="">我要借款</a>
						</li>
						<li>
				...
				<div class="registerCont">
					<ul>
						...
						<li> <span class="dis">验证码:</span>
							...
							<img src="images/code.jpg" alt="验证码" style="cursor:pointer;" id="yzm" class="valign">
							<a class="look blue _changeCapcherButton" id="look" href="javascript:void(0);">看不清？换一张</a> <span class="info" id="jpgVerifys" data-info="请输入手机验证码"></span> </li>
						...
						<li class="agree">
							<input name="protocol" id="protocol" type="checkbox" value="" checked="checked"> 我同意《
							<a href="#" target="_black">亿人宝注册协议</a>》 <span id="protocolAlt" data-info="请查看协议">请查看协议</span></li>
						<li class="btn">
							<a href="javascript:void(0);" class="radius1 _ajaxSubmit">下一步</a>
						</li>
					</ul>
				</div>
			</div>
